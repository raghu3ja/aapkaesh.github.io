...
<head>
	...
	<title>Aapkaeshop - Manage Orders</title>
	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<div class="page-title">
				...
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Order</span> - Manage Orders</h4>
    ...
    <div class="content-wrapper"> 
      ...
      <div class="panel panel-flat">
        ...
        <table class="table datatable-basic table-striped">
          ...
          <tbody>
            <?php 
			$order=$conn->query("SELECT * FROM `cart` ORDER BY id DESC");
			if($order->num_rows>0)
			{
				$i=1;
