                ...
                <table class="table datatable-basic table-striped">
						...
						<tbody>
						 ...
						 <?php 
                                ...
                                <td><?php echo date('d-m-Y H:i:s',strtotime($cat_rows['cdate']));?></td>
                                ...
                                <td width="15%"><a href="delete_category.php?id=<?php echo $cat_rows['cat_id'];?>" onClick="global_delete('category','cat_id',<?php echo $cat_rows['cat_id'] ?>);"><i class="icon-cancel-circle2"></i> Delete</a></td>
