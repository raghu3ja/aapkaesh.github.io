    	...
    	<div class="page-content">
			...
			<div class="content-wrapper">
                ...
                <div class="panel-heading">
						<button type="button" class="btn bg-teal-400 btn-labeled" onClick="window.location.href='add_collage.php'"><b><i class="icon-add"></i></b> Add Products</button>
                ...
                <table class="table datatable-basic table-striped">
						...
						<!--<tbody>
								...
								if($r->num_rows>0)
								{
									...
									<td><?php echo $i; ?></td> 
									<td><?php echo date('Y-m-d H:i:s',strtotime($rows['cdate']));?></td>
