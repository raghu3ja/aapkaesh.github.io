...
//$sel=mysql_query("SELECT * FROM tabl_banner WHERE id='".$_REQUEST['id']."'");
...
if(isset($_REQUEST['submit'])){
	...
	if($file_name1!=""){
		if($_FILES["image"]["error"]==0)
            ...
            $cat=$conn->query("UPDATE `banner` SET
            `bn_img`='".$file_name1."',
            `cdate`=NOW() WHERE `bn_id`='".$_REQUEST['id']."'");
            if(mysqli_affected_rows($conn))
            {
                
                echo "<script>alert('Banner Upadted Successfully');
    ...
    {
	 $cat=$conn->query("UPDATE `banner` SET `date`=NOW() WHERE `bn_id`='".$_REQUEST['id']."'");
            if(mysqli_affected_rows($conn))
            {
...
<head>
	...
	<title>ApkaEshop- Edit Banner</title>
						...
						<form action="" method="post" enctype="multipart/form-data">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
								    <?php 
    						            $cat=$conn->query("SELECT * FROM `banner` where bn_id='".$_REQUEST['id']."'");
        								if($cat->num_rows>0)
        								{
									...
									<fieldset>
                                        ...
                                        <div class="col-md-6">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $res['bn_id'];?>">	
											...
											<div class="col-md-6">
											    ...
											    <img style="height: 100px;" src="img/banner/<?php echo $res['bn_img'];?>">	
