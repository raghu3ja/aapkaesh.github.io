...
if(isset($row3['shop_name'])==($shop_name)&& isset($row4['pincode'])==($pincode))
    ...
    {
      $query="INSERT into shopkeeper_register(cat_id,name,email,mobile,shop_name, address,pincode, password, cdate) VALUES('$category_id','$name','$email','$mobile','$shop_name','$address','$pincode','$password','$date')";
