...
$sql="UPDATE shopkeeper_register set cat_id='$cat_id1',shop_name='$shop_name', mobile='$mobileno', address='$shop_address', pincode='$pincode',  shop_img='$file_name1' WHERE id='".$_SESSION['id']."'";
...
<title>Aapkaeshop - User Profile Details</title>
...
<div class="content-wrapper">
		...
		<!-- Basic layout-->
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
            <?php
             $cat=$conn->query("SELECT * from users where id='".$_SESSION['user_id']."'");
            if($cat->num_rows>0)
            {
          
              while($user_rows= $cat->fetch_assoc())
              {   
              ?> 
                 <div class="col-md-8">
					...
					<input type="text" placeholder="Name" class="form-control" value="<?php echo $user_rows['name']; ?>" name="name" readonly>
					</div>
                 </div>
                 ...
                 <div class="col-md-8">
					<div class="form-group">
					<label>Gender:</label>
					Male <input type="radio" value="male" name="gender"  <?php echo ($user_rows['gender']=='male')?'checked':''; ?>>
					Female <input type="radio" value="female" name="gender"  <?php echo ($user_rows['gender']=='female')?'checked':''; ?>>
					</div>
                </div>
                ...
                <div class="col-md-8">
					...
					<input type="text" placeholder="Mobile No" class="form-control" value="<?php echo $user_rows['mobile']; ?>" name="mobile" required>
					</div>
                </div>
                ...
                <div class="col-md-8">
					<div class="form-group">
					<label>Email:</label>
					<input type="email" placeholder="Email No" class="form-control" value="<?php echo $user_rows['email']; ?>" name="email" required>
					</div>
                </div>
