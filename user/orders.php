...
<title>Aapkaeshop - My Order</title>
...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Order</span> - My Orders</h4>
    ...
    <div class="content-wrapper"> 
      ...
      <div class="panel panel-flat">
        ...
        <table class="table datatable-basic table-striped">
          ...
          <tbody>
            <?php 
			$order=$conn->query("SELECT * FROM `cart` WHERE `user_id`='".$_SESSION['user_id']."' ORDER BY id DESC");
			if($order->num_rows>0)
			{
				$i=1;
				...
				{?>
					...
					<td><a href="order_details.php?order_id=<?php echo $ord['id']; ?>"><?php echo $ord['id'];?></a></td>
							<?php 
					$shop=$conn->query("SELECT * FROM `shopkeeper_register` WHERE `id`='".$ord['shop_id']."'");
    			
				if($shop_det= $shop->fetch_assoc())
				{
					?>
					<td><?php echo $shop_det['shop_name'];?></td>
				<?php } ?>
