...
<div class="form-group">
					...
					<?php
						...
						$cat=$conn->query("SELECT * from product WHERE p_id='".$_GET['pro_id']."'");
						if($cat->num_rows>0)
						{
...
<input type="hidden" name="project_name" id="project_name" value="<?php echo $ddsad; ?>">
				<div class="form-group">
				...
				<div class="form-group">
					<button type="button" id="btn" class="btn btn-primary">UPLOAD IMAGE</button>
				</div>
		</form>
		...
		<div id="upload-preview"></div>
		 ...
		 <table class="table datatable-basic table-striped">
						...
						<tbody>
								...
								$r=$conn->query("SELECT * FROM product_slider WHERE p_id='".$_GET['pro_id']."'");
								...
								if($r)
								{
									...
									<img src="../images/product-gallery/<?php echo $rows['image_name'];?>" style="height:50px; width:50px"/>                           
									
									</td>

								
									
									<td width="15%"><a href="delete_slider.php?pro_id=<?php echo $rows['id'];?>" onClick="global_delete('product','p_id',<?php echo $rows['p_id'] ?>);"><i class="icon-cancel-circle2"></i> Delete</a></td>
