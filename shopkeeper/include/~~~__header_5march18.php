	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="home.php" style="padding: 0px 20px;"><img src="assets/images/logo_23.png" alt=""></a>
	...
	<div class="navbar navbar-default" id="navbar-second">
		...
		<div class="navbar-collapse collapse" id="navbar-second-toggle">
			<ul class="nav navbar-nav" style="margin-left: 5px;">
                ...
                <li class="dropdown">
					<a href="manage_product.php" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
						<i class="icon-bag position-left"></i> Product <span class="caret"></span>
					</a>

					<ul class="dropdown-menu width-250">
						<li>
							<a href="manage_product.php"><i class=" icon-pencil7"></i> Add Product</a>
						</li>
                        
                        <li>
							<a href="product_option.php"><i class="icon-popout"></i> Product Option</a>
						</li>
                ...
                <li>
                            ...
                            <i class="icon-popout"></i> Orders</a>
						</li>
                        
                        <li>
							<a href="banner.php" aria-expanded="false">
                            <i class="icon-popout"></i> Banner</a>
						</li> 
