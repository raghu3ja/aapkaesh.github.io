		...
		<nav class="navbar">
			<div class="container">
				...
				<?php 
					...
					?>
					  <ul class="account-section">
						<li class="dropdown"><a href="shopkeeper/orders.php"><i class="fa fa-user"></i> <?php //echo $_SESSION['name']; ?></a></li>
					  </ul>
					<?php
					  }
				     else
		...
		<div class="col-md-6 find-shop">
			...
			<form action="shop-categories.php" method="GET" >
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Shop Name (Optional)" name="shop_name">
				</div>
